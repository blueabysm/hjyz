...
include("editTopticColumnsClass.inc.php");

$myPageClass = new editTopticColumnsClass($_POST,$_GET,$mysqldao);
...
<HTML>
	...
	<div id="divMainForm">
	<br>
		<form id="editToptic" name="editToptic" method="post">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9">修改专题</td>
				</tr>
				<tr>
						...
						<table cellSpacing="1" cellPadding="0" width="99%" align="center" bgColor="#ebebeb"
							...
							<tr>
								<td class="FormLabel" colSpan="2">
									...
									<input type="hidden" name="columns_toptic_id" id="columns_toptic_id" value="<?=$myPageClass->columns_toptic_id?>"/>
