...
include("addUserClass.inc.php");

$myPageClass = new addUserClass($_POST,$_GET,$mysqldao);
	...
	<br>
		<form id="addSubSite" name="addSubSite" method="post" onsubmit="return checkData()">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9">添加用户</td>
				</tr>
				<tr>
					<td vAlign="middle" align="center" bgColor="#f1f3f5">
						<table cellSpacing="1" cellPadding="0" width="99%" align="center" bgColor="#ebebeb"
							...
							<tr>
								...
								<td class="FormLabel">
								<input type="text"" maxlength="16" name="user_name" id="user_name" style="width: 120px;" value="<?=$myPageClass->user_name?>"/>
								<font color="red">*</font>
								登录后台的用户名(由5-16位的英文小写字母或数字组成),添加后不允许更改								
								</td>
							</tr>
							<tr>
