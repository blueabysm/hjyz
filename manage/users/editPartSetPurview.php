...
include("editPartSetPurviewClass.inc.php");

$myPageClass = new editPartSetPurviewClass($_POST,$_GET,$mysqldao);
	...
	<br>
		<form id="addColumns" name="addColumns" method="post" onsubmit="return checkData()">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9">修改机构设置管理权</td>
				</tr>
				<tr>
					<td vAlign="middle" align="center" bgColor="#f1f3f5">
						<table cellSpacing="1" cellPadding="0" width="99%" align="center" bgColor="#ebebeb"
							...
							<tr>
								<TD class="FormLabel" align="right" width="20%">单位名称:</TD>
								<TD class="FormLabel"><?=$myPageClass->obj_name?></TD>
							</tr>							
							<TR>
