...
include("addNoticeClass.inc.php");

$myPageClass = new addNoticeClass($_POST,$_GET,$mysqldao);
	...
	<br>
		<form id="addSubSite" name="addSubSite" method="post"  onsubmit="return GetData();">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9"><?=$myPageClass->columnsName?> - 添加会议通知</td>
				</tr>
				<tr>
