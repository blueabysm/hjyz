...
include("editLinkColumnsClass.inc.php");

$myPageClass = new editLinkColumnsClass($_POST,$_GET,$mysqldao);
	...
	<br>
		<form id="editLink" name="editLink" method="post">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9">添加/修改链接条</td>
				</tr>
				<tr>
					<td vAlign="middle" align="center" bgColor="#f1f3f5">
						<table cellSpacing="1" cellPadding="0" width="99%" align="center" bgColor="#ebebeb"
							...
							<TR>
								...
								<a href='manageLinkColumns.php?id=<?=$myPageClass->columns_id?>&retURL=<?=$myPageClass->retURL?>'>返回链接条列表</a>								
								</TD>
							</TR>
							<TR>
							...
							<tr>
								<td class="FormLabel" colSpan="2">
									...
									<input type="hidden" name="columns_link_id" id="columns_link_id" value="<?=$myPageClass->columns_link_id?>"/>
