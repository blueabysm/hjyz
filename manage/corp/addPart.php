...
include("addPartClass.inc.php");

$myPageClass = new addPartClass($_POST,$_GET,$mysqldao);
	...
	<br>
		<form id="addPart" name="addPart" method="post">
			<table id="FormTable" cellSpacing="1" cellPadding="0" width="98%" align="center" bgColor="#ffffff"
				border="0">
				<tr>
					<td class="FormCaption" align="center" bgColor="#668cd9">添加机构信息</td>
				</tr>
				<tr>
					<td vAlign="middle" align="center" bgColor="#f1f3f5">
						<table cellSpacing="1" cellPadding="0" width="99%" align="center" bgColor="#ebebeb"
							...
							<tr>
								...
								<td class="FormLabel">请在添加完成后，指定该机构的子栏目，然后再修改此机构信息时指定首个栏目	</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="FormLabel" colSpan="2">
									<input type="submit" name="btnSave" id="btnSave" value="添加"/>									
