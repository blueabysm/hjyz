...
class manageArticleClass{
	...
	public $up_page;
 	...
 	function Page_Load()
 	{
		...
		$sqlstr = "select columns_name from columns where columns_id=$this->columnsID and $this->columnsID in (select obj_id from my_object where menu_id=34 and user_id=".$_SESSION["sess_user_id"].")";
