	...
	<tr>
		...
		<table height="99%" cellSpacing="1" cellPadding="0" width="100%"
			...
			<tr>
				...
				<a href='editArticle.php?item_id=<?=$myPageClass->columnsID?>&page=<?echo $myPageClass->to_page?>&retURL=<?=$myPageClass->retURL?>'>添加新文章</a>				
				</td>
			</tr>
			<tr>
				...
				<TABLE cellSpacing="1" cellPadding="1" width="100%"	bgColor="#ffffff" border="0">
					<tr>
						<td class="TableTdCaption" width="45%" align="center">标题</td>
