...
if ($article == -1){
	...
	$strIndex =	strpos($article_from,ONLINE_ADD_ARTICLE_FROM_NAME);
	if ($strIndex >=0){						
		$article_from = ONLINE_ADD_ARTICLE_FROM_NAME;
	} 
...
<div class="content">
  ...
  <div class="messsage"> <span><?=$article_time?>  作者：<?=$article_ath?> 来源：<?=$article_from?> 浏览次数：<?=$click_count?> 网友评论 <font color="red"><?=$c_count?></font> 条</a></span> </div>
