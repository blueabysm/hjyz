<div class="contentLeft">
        <div class="l_xinxi">
            ...
            <div class="l_xinxiList">
            	<div id="s_part1" class="box4 current2" onclick="sliderOnMouseOver(partSlider,0)"><a><?=$colmnusNames[41]?></a></div>
                <div class="box5" id="s_part1_c">                    
                    <?php showHeadListById($mysqldao,324,'text_list3','more4',0); ?>
                </div>
                <div id="s_part2" class="box4" onclick="sliderOnMouseOver(partSlider,1)"><a><?=$colmnusNames[42]?></a></div>
                <div class="box5" id="s_part2_c" style="display: none;">	             
