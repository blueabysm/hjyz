...
document.writeln('        <td colspan=5 align=right Author=meizz><span id="clos" onclick=closeLayer() style="font-size:12px;cursor: hand"');
...
function LoadDate(o,initYear){
	if(initYear!=""){
		meizzTheYear=initYear;
	}
	else{
...
function setday(tt,year,obj) //主调函数
{
