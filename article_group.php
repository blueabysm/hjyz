...
<div class="content"> 
    ...
    <div class="box1">
	  <div class="list">
        ...
        <h2 style="font-size:11pt;"><?=$colmnusNames[$cols[$i]]?> (<a style="font-size: 9pt" href="article_more.php?id=<?=$cols[$i]?>">>>更多</a>)</h2>
        <?php showwzlmByID($mysqldao,$cols[$i],'ul','','y-m-d',10,38); ?>       
        <?php }?>
